...
try {
    ...
    String query = "INSERT INTO providers (name, phone, address, email, password,service_type) VALUES (?, ?, ?, ?, ?,?)";
    ...
    pstmt.setString(6, user_service);
    int i = pstmt.executeUpdate();

    if (i > 0) {
     response.sendRedirect("serlog.html");
    } else {
